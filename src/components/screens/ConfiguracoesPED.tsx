/**
 * MOVIOCA - Configurações PED
 * 
 * Tela de configurações para Produção Executiva Dedicada.
 * 
 ...
 * 
 * PRD 005 - Configurações do Perfil PED
 */
...
export default function ConfiguracoesPED() {
  const { currentUser } = useAuth();

  // Dados do Perfil
  const [nome, setNome] = useState(currentUser?.name || "Ana Silva");
  const [email, setEmail] = useState("ana.silva@movioca.com");
  const [telefone, setTelefone] = useState("(11) 98765-4321");
  const [cargo, setCargo] = useState("Produção Executiva Dedicada");
  ...
  const [alertaContratos, setAlertaContratos] = useState(true);
  const [alertaSaldo, setAlertaSaldo] = useState(true);
            ...
            <CardContent className="pt-6">
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Receber resumo diário de atividades do projeto
                      </p>
                    </div>
                    <Switch
                ...
                <div className="border-t pt-4">
                  <h4 className="font-semibold mb-4">Alertas Específicos</h4>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        <Label>Contratos aguardando assinatura</Label>
                        <p className="text-sm text-muted-foreground">
                          Notificar sobre contratos em status &quot;Minuta&quot;
                        </p>
                      </div>
                      <Switch
                        checked={alertaContratos}
                        onCheckedChange={setAlertaContratos}
                      />
                    </div>

                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        <Label>Saldo baixo em rubricas</Label>
                        <p className="text-sm text-muted-foreground">
                          Notificar quando saldo ficar abaixo de 20%
                        </p>
                      </div>
                      <Switch
                        checked={alertaSaldo}
                        onCheckedChange={setAlertaSaldo}
                      />
                    </div>
                  </div>
                </div>
